          ...
          <form className="mb-6" onSubmit={handleSubmit}>
            {token ? (
              ...
              <div className="flex flex-col gap-1 relative">
                <div className="py-2 px-4 mb-4 bg-white rounded-lg rounded-t-lg border border-gray-200  dark:border-gray-700 blur-sm">
                  <label for="comment" className="sr-only">
                    Your comment
                  </label>
                  <textarea
                ...
                <a
                  href="/login"
                  className="text-sm bg-blue-500 text-white p-3 rounded-full mx-auto cursor-pointer absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 transform"
                >
                  Sign In to Comment
                </a>
              </div>
